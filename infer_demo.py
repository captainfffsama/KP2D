...
class KeyPointModel(object):
    def __init__(self,ckpt_path:str,conf_thresh:float=0.0, keep_k_points=1000):
    ...
    def __call__(self,image_path,warped_image_path):
        image_t=self.read_img(image_path)
        warped_image_t=self.read_img(warped_image_path)
